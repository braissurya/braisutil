...
public class PpucDController extends ParentController{
	...
	@RequestMapping(value = "/{no_ppuc}/{tgl_ppuc}/{divisi_kd}/{subdiv_kd}/{dept_kd}/{lok_kd}/{kd_biaya}", produces = "text/html")
	public String show(@PathVariable("no_ppuc") String no_ppuc, @PathVariable("tgl_ppuc") Date tgl_ppuc, @PathVariable("divisi_kd") String divisi_kd, @PathVariable("subdiv_kd") String subdiv_kd, @PathVariable("dept_kd") String dept_kd, @PathVariable("lok_kd") String lok_kd, @PathVariable("kd_biaya") String kd_biaya, Model uiModel) {
		addDateTimeFormatPatterns(uiModel);
		uiModel.addAttribute("ppucd", ppucdManager.get(no_ppuc, tgl_ppuc, divisi_kd, subdiv_kd, dept_kd, lok_kd, kd_biaya));
		uiModel.addAttribute("itemId", no_ppuc+"/"+tgl_ppuc+"/"+divisi_kd+"/"+subdiv_kd+"/"+dept_kd+"/"+lok_kd+"/"+kd_biaya);
		return "ppucd/show";
	}
	...
	@RequestMapping(value = "/{no_ppuc}/{tgl_ppuc}/{divisi_kd}/{subdiv_kd}/{dept_kd}/{lok_kd}/{kd_biaya}", params = "form", produces = "text/html")
	public String updateForm(@PathVariable("no_ppuc") String no_ppuc, @PathVariable("tgl_ppuc") Date tgl_ppuc, @PathVariable("divisi_kd") String divisi_kd, @PathVariable("subdiv_kd") String subdiv_kd, @PathVariable("dept_kd") String dept_kd, @PathVariable("lok_kd") String lok_kd, @PathVariable("kd_biaya") String kd_biaya, Model uiModel) {
		populateEditForm(uiModel, ppucdManager.get(no_ppuc, tgl_ppuc, divisi_kd, subdiv_kd, dept_kd, lok_kd, kd_biaya));
		return "ppucd/update";
	}

	@RequestMapping(value = "/{no_ppuc}/{tgl_ppuc}/{divisi_kd}/{subdiv_kd}/{dept_kd}/{lok_kd}/{kd_biaya}", method = RequestMethod.DELETE, produces = "text/html")
	public String delete(@PathVariable("no_ppuc") String no_ppuc, @PathVariable("tgl_ppuc") Date tgl_ppuc, @PathVariable("divisi_kd") String divisi_kd, @PathVariable("subdiv_kd") String subdiv_kd, @PathVariable("dept_kd") String dept_kd, @PathVariable("lok_kd") String lok_kd, @PathVariable("kd_biaya") String kd_biaya, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
		PpucD ppucd = ppucdManager.get(no_ppuc, tgl_ppuc, divisi_kd, subdiv_kd, dept_kd, lok_kd, kd_biaya);
		ppucdManager.remove(no_ppuc, tgl_ppuc, divisi_kd, subdiv_kd, dept_kd, lok_kd, kd_biaya);
		uiModel.asMap().clear();
