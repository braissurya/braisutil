...
public class LogEmailController extends ParentController{
	...
	public String create(@Valid LogEmail logemail, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
		...
		return "redirect:/master/logemail/" + encodeUrlPathSegment(logemail.getId().toString(), httpServletRequest);
	}
	...
	public String show(@PathVariable("id") Long id, Model uiModel) {
		...
		uiModel.addAttribute("logemail", logemailManager.get(id));
	...
	public String updateForm(@PathVariable("id") Long id, Model uiModel) {
		populateEditForm(uiModel, logemailManager.get(id));
		return "logemail/update";
	}

	@RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
	public String delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
		LogEmail logemail = logemailManager.get(id);
		logemailManager.remove(id);
		uiModel.asMap().clear();
	...
	void addDateTimeFormatPatterns(Model uiModel) {
		uiModel.addAttribute("logemail_tgl_ppuc_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
		uiModel.addAttribute("logemail_send_date_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
