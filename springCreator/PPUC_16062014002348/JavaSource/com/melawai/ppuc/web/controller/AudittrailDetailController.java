...
public class AudittrailDetailController extends ParentController{
	...
	public String create(@Valid AudittrailDetail audittraildetail, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
		...
		return "redirect:/master/audittraildetail/" + encodeUrlPathSegment(audittraildetail.getId().toString(), httpServletRequest);
	}
	...
	public String show(@PathVariable("id") Long id, Model uiModel) {
		...
		uiModel.addAttribute("audittraildetail", audittraildetailManager.get(id));
	...
	public String updateForm(@PathVariable("id") Long id, Model uiModel) {
		populateEditForm(uiModel, audittraildetailManager.get(id));
		return "audittraildetail/update";
	}

	@RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
	public String delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
		AudittrailDetail audittraildetail = audittraildetailManager.get(id);
		audittraildetailManager.remove(id);
		uiModel.asMap().clear();
