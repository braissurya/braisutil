...
public class UserDivisiController extends ParentController{
	...
	public String create(@Valid UserDivisi userdivisi, BindingResult bindingResult, Model uiModel, HttpServletRequest httpServletRequest) {
		...
		return "redirect:/master/userdivisi/" + encodeUrlPathSegment(userdivisi.getId().toString(), httpServletRequest);
	}
	...
	public String show(@PathVariable("id") Long id, Model uiModel) {
		...
		uiModel.addAttribute("userdivisi", userdivisiManager.get(id));
	...
	public String updateForm(@PathVariable("id") Long id, Model uiModel) {
		populateEditForm(uiModel, userdivisiManager.get(id));
		return "userdivisi/update";
	}

	@RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
	public String delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
		UserDivisi userdivisi = userdivisiManager.get(id);
		userdivisiManager.remove(id);
		uiModel.asMap().clear();
